...
add_image_size( 'featured-medium', 1280, 410, true );
add_image_size( 'featured-large', 1440, 410, true );
add_image_size( 'featured-xlarge', 1920, 700, true );

add_image_size( 'gallery-size', 290, 290, false );

add_image_size( 'showroom-mobile', 145, 260, true );
add_image_size( 'showroom-tablet', 377, 504, true );
add_image_size( 'showroom-desctop', 697, 438, true );

add_image_size( 'team-photo', 278, 278, true );

add_image_size( 'blog-thumb', 350, 240, true );
add_image_size( 'partners-thumb', 150, 180, true );
